...
class ProstateCryoAblationManualSegmentationPlugin(ProstateCryoAblationSegmentationPluginBase):
  ...
  def __init__(self):
    super(ProstateCryoAblationManualSegmentationPlugin, self).__init__()

  def setupIcons(self):
    self.settingsIcon = self.createIcon('icon-settings.png')

  def setup(self):
    super(ProstateCryoAblationManualSegmentationPlugin, self).setup()
    try:
  ...
  def onActivation(self):
    super(ProstateCryoAblationManualSegmentationPlugin, self).onActivation()
  ...
  def onDeactivation(self):
    super(ProstateCryoAblationManualSegmentationPlugin, self).onDeactivation()

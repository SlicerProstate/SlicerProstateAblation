...
from plugins.targeting import ProstateCryoAblationTargetingPlugin
from plugins.segmentation.manual import ProstateCryoAblationManualSegmentationPlugin
from plugins.segmentation.automatic import ProstateCryoAblationAutomaticSegmentationPlugin
from ..constants import ProstateCryoAblationConstants as constants


class ProstateCryoAblationSegmentationStepLogic(ProstateCryoAblationLogicBase):

  def __init__(self):
    super(ProstateCryoAblationSegmentationStepLogic, self).__init__()


class ProstateCryoAblationSegmentationStep(ProstateCryoAblationStep):

  NAME = "Segmentation"
  LogicClass = ProstateCryoAblationSegmentationStepLogic

  def __init__(self):
    self.modulePath = os.path.dirname(slicer.util.modulePath(self.MODULE_NAME)).replace(".py", "")
    super(ProstateCryoAblationSegmentationStep, self).__init__()
  ...
  def setup(self):
    super(ProstateCryoAblationSegmentationStep, self).setup()
  ...
  def setupManualSegmentationPlugin(self):
    self.manualSegmentationPlugin = ProstateCryoAblationManualSegmentationPlugin()
  ...
  def setupAutomaticSegmentationPlugin(self):
    self.automaticSegmentationPlugin = ProstateCryoAblationAutomaticSegmentationPlugin()
  ...
  def setupConnections(self):
    super(ProstateCryoAblationSegmentationStep, self).setupConnections()
  ...
  def onActivation(self):
    ...
    super(ProstateCryoAblationSegmentationStep, self).onActivation()
  ...
  def onDeactivation(self):
    super(ProstateCryoAblationSegmentationStep, self).onDeactivation()
  ...
  def setupSessionObservers(self):
    super(ProstateCryoAblationSegmentationStep, self).setupSessionObservers()
    self.session.addEventObserver(self.session.InitiateSegmentationEvent, self.onInitiateSegmentation)

  def removeSessionEventObservers(self):
    super(ProstateCryoAblationSegmentationStep, self).removeSessionEventObservers()

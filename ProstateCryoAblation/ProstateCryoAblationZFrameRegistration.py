...
class ProstateCryoAblationZFrameRegistration(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "ProstateCryoAblation ZFrame Registration"
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['ProstateCryoAblationZFrameRegistration'] = self.runTest

  def runTest(self):
    tester = ProstateCryoAblationZFrameRegistration()
    tester.runTest()


class ProstateCryoAblationZFrameRegistrationWidget(ScriptedLoadableModuleWidget, ModuleWidgetMixin):
  ...
  def __init__(self, parent=None):
    ...
    self.logic = ProstateCryoAblationZFrameRegistrationLogic()
...
class ProstateCryoAblationZFrameRegistrationLogic(ScriptedLoadableModuleLogic, ModuleLogicMixin):
